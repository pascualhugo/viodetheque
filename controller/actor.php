...
<section>
    ...
    <main>
        <article class="container box">
            <h1>Zack Snyder</h1>
            <figure>
                <img src="../images/Zack_Snyder.jpg" class="portrait">
            </figure>
            <p><strong>Nationalité</strong> Américain</p>
            <p><strong>Naissance</strong> 1 mars 1966 (Green Bay, Wisconsin - Etats-Unis)</p>
            <section>
                <h2>Biographie</h2>
        ...
        <aside class="container box">
            <h1>Filmographie</h1>
            <ul>
                <li>L'armée des morts - 2004</li>
                <li>300 - 2006</li>
                <li>Watchemen - 2009</li>
                <li>Sucker Punch - 2011</li>
                <li>Man of Steel - 2013</li>
                <li>Batman vs Supermam - 2016</li>
            </ul>
        </aside>
    </main>
    <footer class="menu box">Hugo Pascual ©</footer>
</section>
